<template>
  <div class="container w-1/2 mx-auto my-12 bg-gray-100 rounded p-4">
    <form @submit.prevent="postForm()">
      <div class="flex flex-col mx-auto items-center">

        <div class="w-5/6">

          <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Название
            Проекта</label>
          <input type="text" id="title" v-model="form.title"
                 class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="flex mt-2 justify-around items-center w-3/6">
          <label for="director"
                 class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Рукаводитель:</label>
        ...
        <div class="w-5/6">
          <label for="description"
                 class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Краткое описание</label>
        ...
        <div class="flex justify-center m-4 items-center w-full">
          <label for="icon"
            ...
            <input id="icon" type="file" @input="form.photo = $event.target.files[0]" class="hidden"/>
          </label>
        </div>
        <button type="submit"
