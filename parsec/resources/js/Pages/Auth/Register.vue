    ...
    <div class="w-full max-w-md space-y-8">
      <div>
        <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
             alt="Your Company">
        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Создовать новый аккаунт</h2>
        <p class="mt-2 text-center text-sm text-gray-600">
          Или
          <a :href="route('login')" class="font-medium text-indigo-600 hover:text-indigo-500">У тебя уже есть</a>
        </p>
      </div>
