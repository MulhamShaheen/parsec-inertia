...
<!--          <div class="relative">-->
<!--            &lt;!&ndash; Item active: "text-gray-900", Item inactive: "text-gray-500" &ndash;&gt;-->
...
<!--                    &lt;!&ndash; Heroicon name: outline/lifebuoy &ndash;&gt;-->
...
<!--                  <a href="#" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">-->
<!--                    &lt;!&ndash; Heroicon name: outline/bookmark-square &ndash;&gt;-->
<!--                    <svg class="h-6 w-6 flex-shrink-0 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">-->
...
<!--          <div v-if="auth">-->
<!--            <a href="/logout" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Выход</a>-->
<!--            <a href="/account" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Личный кабинет</a>-->
<!--          </div>-->
<!--          <div v-else>-->
<!--            <a href="/login" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Вход</a>-->
<!--            <a href="/register" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Регестрация</a>-->
